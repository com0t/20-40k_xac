...
class Exporter
{
    ...
    protected function addFreeProductsRepeatAndSubtotal($ruleObject)
    {
        ...
        } elseif ($ruleObject->getItemGiftStrategy() === $ruleObject::BASED_ON_SUBTOTAL_ITEM_EXCL_TAX_GIFT_STRATEGY) {
            $free_products['repeat']          = "based_on_subtotal";
            $free_products['repeat_subtotal'] = $ruleObject->getItemGiftSubtotalDivider();
        } elseif ($ruleObject->getItemGiftStrategy() === $ruleObject::BASED_ON_SUBTOTAL_ITEM_INCL_TAX_GIFT_STRATEGY) {
