 ...
 *
 *
 * Copyright 2020-2021 Ciprian Popescu (email: getbutterfly@gmail.com)
...
function admin_menu_tree_page_view_admin_init() {
    ...
    wp_add_inline_script('admin_menu_tree_page_view', 'const amtpv_l10n = ' . json_encode([
